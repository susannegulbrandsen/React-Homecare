...
namespace HomeCareApp.DTOs
{
    ...
    {
        [Required] // Medication name is required when creating or updating a medication
        ...
        [Required] // Indication is required when creating or updating a medication
        [StringLength(200, ErrorMessage = "Indication cannot exceed 200 characters.")]
        public string Indication { get; set; } = "";
        
        [Required] // Dosage is required when creating or updating a medication
        [StringLength(100, ErrorMessage = "Dosage cannot exceed 100 characters.")]
        public string Dosage { get; set; } = "";
        
        [Required] // StartDate is required when creating or updating a medication
